...
Compares official guidance vs market pricing to detect credibility gaps. Checks 9 dimensions: (1) USDIDR vs APBN 16,500 assumption (flagged >10% gap); (2) Brent ICP vs APBN $70/bbl (flagged >10%); (3) CDS vs "stable macro" claim (flagged >150bps); (4) SBN 10Y term premium vs BI Rate stance (flagged term premium >2%); (5) FX reserves + SRBI vs "orderly market" claim; (6) food CPI vs APBN implied ~3.75% food CPI (flagged >6% or <0%); (7) compound IDR+oil double-whammy = real subsidy cost overshoot (flagged >20% combined); (8) USDIDR vs Relative PPP fair value — R&R Ch.4-5, Dornbusch overshoot flag; (9) **BBM domestic price vs cost recovery** — Pertalite pump price vs `(Brent×USDIDR)/158.987×1.40`; flags "harga BBM terjangkau" narrative when subsidy gap >IDR 2k/liter. Narrative Credibility Score = 100 − avg_divergence (higher = more credible). Sources: DB cross-feeds (Brent, USDIDR, reserves, SRBI, SBN yield, BI rate, food CPI, pertalite price) — no Playwright fetch, reads cached values. Silent Crisis Detector weight: 0.02.
